...
Open an issue using the [`New project template`](https://github.com/qiskit-community/qiskit-camp-europe-19/issues/new?assignees=&labels=members+wanted&template=new-project-template.md&title=Project+name) template.
